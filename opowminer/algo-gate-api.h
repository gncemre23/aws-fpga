...
int ( *scanhash ) ( struct work*, uint32_t, uint64_t*, struct thr_info*, uint32_t *  golden_i, uint32_t * circ_buffer,  uint32_t *found_nonce_count, pthread_mutex_t *fpga_lock );
