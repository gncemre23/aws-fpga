...
rt::set_parameter PartId {xcvu9p-flgb2104-2-i}
...
rt::set_parameter helper_shm_key {LaunchHelperProcessKey_32279_1623163571}
...
set_msg_config  -string {{WRAPPER_INST/SH}}  -severity {CRITICAL WARNING}  -suppress 
set_msg_config  -string {{WRAPPER_INST/SH}}  -severity {WARNING}  -suppress 
